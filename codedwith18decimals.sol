...
contract EnterChain is ERC20Interface{
    string public name = "EnterChain"; // full coin name
    string public symbol = "ECHAIN";  // coin trading symbol
    uint public decimals = 18; //the decimals available for the token
    ...
    constructor() public{
        supply = 10000000000 * 10 ** decimals; //* 10 ** decimals allows for 18 decimals
        founder = msg.sender;
 ...
 //below code for ICO
contract EnterChainICO is EnterChain{  
    ...
    //token price in wei: 1ECHAIN = 0.0000001 ETHER, 1 ETHER = 20000000 ECHAIN
    uint tokenPrice = 20000000;
    
    //250 Ether in wei
    uint public hardCap = 250000000000000000000;
    
    uint public raisedAmount;
    
    uint public saleStart = now;
    uint public saleEnd = now + 1209600; //two weeks = 1209600 (in seconds)
    uint public coinTradeStart = saleEnd + 1; //transferable 1 second after sale ends
    
    uint public maxInvestment = 5000000000000000000; //max investment for ICO is 5 eth;
    uint public minInvestment = 100000000000000000;  //min investment for ICO is .1 eth;
